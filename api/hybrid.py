...
async def sensor_loop():
    ...
    while True:
        ...
        if data:
            ...
            print("LIVE SENSOR:", latest_sensor_data.dict())
...
async def sensor_stream():
    ...
    async def event_generator():
        ...
        while True:
            ...
            yield f"data: {json.dumps(latest_sensor_data.dict())}\n\n"
...
async def predict(file: UploadFile = File(...)):
    ...
    try:
        ...
        filename = f"{timestamp}_{predicted_class}.jpg"
